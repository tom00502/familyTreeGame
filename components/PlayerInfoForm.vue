<template>
  <div class="min-h-screen bg-[#FAF8F3] flex flex-col items-center justify-center p-6">
    <div class="w-full max-w-[390px] flex flex-col items-center gap-6 relative z-10">
      <!-- Logo -->
      <div class="w-20 h-20 bg-[#8B2635] rounded-full flex items-center justify-center border-4 border-[#D4AF37] shadow-lg">
        ...
        <div class="space-y-2">
          ...
          <div class="grid grid-cols-2 gap-3">
            <button
              ...
              class="py-3 rounded-md border-2 transition-all font-medium flex items-center justify-center gap-2"
              :class="
